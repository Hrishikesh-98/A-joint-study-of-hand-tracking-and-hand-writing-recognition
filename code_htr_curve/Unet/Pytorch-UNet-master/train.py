...
train_dir_img = Path('../../../extra/data/hrishikesh/stroke_black/train/')
train_dir_mask = Path('../../../extra/data/hrishikesh/stroke_mask/train/')
val_dir_img = Path('../../../extra/data/hrishikesh/stroke_black/val/')
val_dir_mask = Path('../../../extra/data/hrishikesh/stroke_mask/val/')
dir_checkpoint = Path('../../../extra/data/hrishikesh/checkpoints/')
