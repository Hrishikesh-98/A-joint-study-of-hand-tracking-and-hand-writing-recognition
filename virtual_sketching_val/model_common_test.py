...
class DiffPastingV3(object):
    ...
    def image_pasting_sampling_v3(self):
        print('cursor_pos_a : ',self.cursor_pos_a[0])
        print('image_size_a : ',self.image_size_a)
        print('window_size_a : ',self.window_size_a)
        print('raster_size_a : ',self.raster_size_a)
        ...
        print('x1y1_a_floor : ',x1y1_a_floor)
        print('x2y2_a_ceil : ',x2y2_a_ceil)
        ...
        print('cursor_pos_b : ',cursor_pos_b)
        print('image_size_b : ',image_size_b)
        print('window_size_b : ',window_size_b)
        print('raster_size_b : ',raster_size_b)
...
class VirtualSketchingModel(object):
    ...
    def get_points_and_raster_image(self, image_size):
        ...
        for time_i in range(self.hps.max_seq_len):
            ...
            #print("cnn output : image_embedding1 : ", combined_z[0].shape, " image_embedding2 : ", combined_z[1].shape)
            combined_z = tf.expand_dims(combined_z, axis=1)  # (N, 1, z_size)
            #print("expanding : image_embedding1 : ", combined_z[0].shape, " image_embedding2 : ", combined_z[1].shape)
