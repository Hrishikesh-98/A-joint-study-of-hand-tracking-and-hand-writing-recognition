...
def data_convert_to_absolute(npz_path, svg_type):
    ...
    svg_data_base = os.path.join(file_base, 'svgs')
    ...
    save_path = os.path.join(svg_data_base, file_name + '.svg')
...
if __name__ == '__main__':
    ...
    f = open("../../../extra/data/hrishikesh/hwnet-master/ann/test_stroke_ann.txt",'r')
    lines = f.readlines()
    #folder = '../npzs_test/clean_line_drawings__pretrain_clean_line_drawings/seq_data/'
    folder = '../../../extra/data/hrishikesh/npzs_stroke_256_test/clean_line_drawings__pretrain_clean_line_drawings/seq_data/'
    for line in lines:
        #name = line.split()[0].split('/')[1] + '.npz'
        name = line.split()[0].split("/")[1].split('.')[0] + '.npz'
        args.file = folder+name
